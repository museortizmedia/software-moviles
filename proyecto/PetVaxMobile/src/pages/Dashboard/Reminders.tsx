...
export const Reminders: React.FC = () => {
  return (
    <>
      ...
      <Card title="Vacuna de refuerzo" subtitle="Luna">
        <p className="text-sm text-[#475569]">Dosis programada para el 05/06/2026</p>
      </Card>

      <Card title="Control veterinario" subtitle="Milo">
        <p className="text-sm text-[#475569]">Programado para el 18/06/2026</p>
      </Card>
    </>
  );
};
